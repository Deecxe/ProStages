 ...
 */
final class Version20220105141312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, type_entreprise_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, mission VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_C27C9369D44318DF (type_entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE stage ADD CONSTRAINT FK_C27C9369D44318DF FOREIGN KEY (type_entreprise_id) REFERENCES entreprise (id)');
